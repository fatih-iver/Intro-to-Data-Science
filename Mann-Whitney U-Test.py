...
def mann_whitney_plus_means(turnstile_weather):
    ...
    U, p = scipy.stats.mannwhitneyu(turnstile_weather[turnstile_weather['rain'] == 1.0]['ENTRIESn_hourly'],turnstile_weather[turnstile_weather['rain'] == 0.0]['ENTRIESn_hourly'])
